...
namespace AutomationWrapper.Base
{
    ...
    //    public void Initialization()
    //    {
    //        string browser = JsonUtils.GetValue(@"C:\Users\Tony\Desktop\Soller.edu\Soller.edu_2\Selenium Testing\OpenEmrApplication\TestData\data.json", "browser");
    ...
    //        driver.Manage().Window.Maximize();
    //        driver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
    //        string baseUrl = JsonUtils.GetValue(@"C:\Users\Tony\Desktop\Soller.edu\Soller.edu_2\Selenium Testing\OpenEmrApplication\TestData\data.json", "url");
    //        driver.Url = baseUrl;
    //    }
    //    [TearDown]
    //    public void EndBrowser()
