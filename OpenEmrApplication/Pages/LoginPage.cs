...
namespace OpenEmrApplication.Pages
{
    class LoginPage
    {
        ...
        private By ackLocator = By.PartialLinkText("Acknowledgments");
        ...
        public void ClickOnAcknowledgementsLicensingCertification()
        {
            driver.FindElement(ackLocator).Click();
        }
        ...
        public void switchToAcknowledgementsLicensingCertificationTab()
        {
